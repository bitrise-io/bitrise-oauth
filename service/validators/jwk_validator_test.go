...
func NewCounter(expected int) InvokeCounter {
	return InvokeCounter{Expected: expected}
}

func (counter *InvokeCounter) Increment() {
	counter.Actual++
}
